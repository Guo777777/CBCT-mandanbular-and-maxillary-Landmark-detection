...
def main():
    ...
    ap.add_argument('--global-ckpt', required=True, help='stage-1 tooth-region checkpoint (your own; the paper weights are lost)')
    ap.add_argument('--local-ckpt', required=True, help='stage-2 landmark checkpoint from scripts/4_train_landmark.py')
